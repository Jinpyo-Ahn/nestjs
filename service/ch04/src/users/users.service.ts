...
export class UsersService {
    constructor(private emailSerive: EmailService) { }
    ...
    private checkUserExists(email: string) { // 1
    ...
    private async sendMemberJoinEmail(email: string, signupVerifyToken: string) { // 3
        await this.emailSerive.sendMemberJoinVerification(email, signupVerifyToken);
    }
